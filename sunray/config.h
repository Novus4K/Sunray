...
and deactivate Due clone reset circuit (JP13):
...
// ------------------------------------- MQTT (for ESP8266 only) -------------------------------------
// highly experimental - ENABLE_SERVER must be set to false for this to work :-/
...
#define BUTTON_CONTROL  true      // additional features activated (press-and-hold button for specific beep count:
                                  // 1 beep=stop, 3 beeps=R/C mode ON/OFF, 5 beeps=dock, 6 beeps=start, 9 beeps=shutdown, 12 beeps=WiFi WPS
